...
class FtpProtocol:
    ...
    def feed(self):
        ...
        while True:
            ...
            while (last_content_len + content_len > self.CONTENT_MAX_LENGTH):
                self.__send(self.__pack(last_content + content[:self.CONTENT_MAX_LENGTH-last_content_len], 0, self.request, True, fragment_id, False))
                last_content = content[self.CONTENT_MAX_LENGTH-last_content_len:]
                last_content_len -= self.CONTENT_MAX_LENGTH
                fragment_id += 1
