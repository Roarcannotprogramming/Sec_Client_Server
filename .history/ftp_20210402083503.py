...
class FtpProtocol:
    ...
    def __pack(self, content, hb, request, fragment=False, fragment_id=0):
        ...
        if fragment == True:
            ...
            p = bytes([(self.version & 7) | (0 << 3) | (self.request << 4), package_len & 0xff, (package_len >> 8) & 0xff, package_len >> 16, self.fragment_id & 0xff, (self.fragment_id >> 8) & 0xff, (self.fragment_id >> 16) & 0xff, self.fragment_id >> 24])
